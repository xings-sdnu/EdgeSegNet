...
class hyperseg_efficientnet(BaseModel):
    def __init__(self, model_name, pretrained=False, levels=3, down_groups=1, flat_groups=1, weight_groups=1,
                          avg_pool=True, weights_path=None, **kwargs):
        super(hyperseg_efficientnet, self).__init__()
